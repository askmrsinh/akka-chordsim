Akka ChordSim — Akka based Chord algorithm simulation
=====================================================
...
The implementation is resilient to network failures, provides necessary logging to see work routing/assignment and 
...
1. [About the Chord Protocol](#1-about-the-chord-protocol)
2. [Some Important Files](#2-some-important-files)
3. [Application Design](#3-application-design)
4. [Setup Instructions (Docker)](#4-setup-instructions-docker)
5. [Usage Details](#5-usage-details)
    - 5.1 [Configuration Details](#51-configuration-details)
    - 5.2 [Sample Execution Results](#52-sample-execution-results)
6. [Additional Logs](#6-additional-logs)
7. [Visualization and Demo](#7-visualization-and-demo)
...
of Chord nodes. Chord is a distributed lookup protocol that addresses the problem of efficient lookup in a 
...
Listed below are different dependencies required for this projects:
...
fingertable of the node to find the right successor for the work assignment and it is passed along in the ring. 
This process continues until the file is stored. A similar process is followed when the result needs to be redirected 
...
It is then passed along in the ring using the implementation details of Chord, until it reaches the target worker node.
